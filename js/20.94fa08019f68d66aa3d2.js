...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.basicColumn = [{
      ...
      customer_component: 'tag'
    }, {
      prop: 'tags',
      label: this.$t('table.tag'),
      customer_component: 'tags'
    }, {
      prop: 'published_at',
          ...
          scopedSlots: _vm._u([
            {
              ...
              fn: function () {
                return [
                  _vm.item.customer_component === "image"
                    ? _c("el-image", {
                        staticStyle: {
                          width: "100px",
                          height: "100px",
                        ...
                        attrs: {
                          "preview-src-list": _vm.scope.row["preview_src_list"],
                          src: _vm.scope.row[_vm.item.prop],
                        },
                      })
                    : _vm._e(),
                ]
