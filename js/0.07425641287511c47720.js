...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleToggleRowSelection: function handleToggleRowSelection(row, isSelected) {
      var _this = this;

      this.$nextTick(function () {
        _this.$refs.table.toggleRowSelection(row, isSelected);
      });
    }
  }
});
            ...
            _vm._b(
              {
                ...
                style:
                  "width: 100%; height: " +
                  (_vm.tableHeight === "" ? "100%" : _vm.tableHeight),
                attrs: {
            ...
            _vm._l(_vm.tableColumn, function (item, index) {
              return [
                item.filters
                            ...
                            fn: function (scope) {
                              return [
                                item.slot
                                  ...
                                  : _c("span", [
                                      _vm._v(
                                        _vm._s(_vm.show(scope.row, item.prop))
                                      ),
                                    ]),
                              ]
                            },
                  ...
                  : item.type === "selection"
                  ? _c("el-table-column", {
                      attrs: { type: item.type, width: item.width },
                    })
                  : _c("el-table-column", {
                      key: index,
                      attrs: {
            ...
            _vm.tableOption.label
              ? _c("el-table-column", {
                  attrs: {
                    ...
                    align: _vm.tableOption.align
                      ? _vm.tableOption.align
                      : "center",
                        ...
                        fn: function (scope) {
                          return [
                            _vm.tableOption.item_actions
                              ? [
                                  _vm.tableOption.item_actions.length <= 3
                                    ? _vm._l(
                                        _vm.tableOption.item_actions,
