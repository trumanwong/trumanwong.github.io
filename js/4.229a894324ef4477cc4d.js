...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      ...
      if (!this.link.image) {
        this.$message.error('The image is required!');
        return;
      }
      ...
      this.$http[method](url, this.link).then(function (response) {
        _this.$message.success('You ' + _this.mode + 'd the link information success!');
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("el-input", {
                attrs: { placeholder: _vm.$t("form.link_name"), clearable: "" },
                model: {
                  value: _vm.link.name,
                  callback: function ($$v) {
          ...
          _c(
            ...
            [
              _c("el-input", {
                attrs: { placeholder: _vm.$t("form.link"), clearable: "" },
                model: {
                  value: _vm.link.link,
                  callback: function ($$v) {
