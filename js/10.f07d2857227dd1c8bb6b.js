...
/* harmony import */ var _components_CustomerTable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/CustomerTable */ "./resources/js/dashboard/components/CustomerTable.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    CustomerTable: _components_CustomerTable__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: function data() {
    return {
      files: null,
    ...
    tableActions: function tableActions(action, data) {
      ...
      if (action == 'delete-item') {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          _this2.$http["delete"]('file/' + data.id).then(function (response) {
                ...
                fn: function (ref) {
                  ...
                  return [
                    _c("el-image", {
                      ...
                      attrs: { "preview-src-list": [row.path], src: row.path },
                    }),
                  ]
                },
              },
