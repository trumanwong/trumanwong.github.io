...
/* harmony import */ var dashboard_components_particals_Sidebar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dashboard/components/particals/Sidebar */ "./resources/js/dashboard/components/particals/Sidebar.vue");
/* harmony import */ var dashboard_components_particals_Navbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dashboard/components/particals/Navbar */ "./resources/js/dashboard/components/particals/Navbar.vue");
/* harmony import */ var dashboard_components_particals_FooterBar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dashboard/components/particals/FooterBar */ "./resources/js/dashboard/components/particals/FooterBar.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Sidebar: dashboard_components_particals_Sidebar__WEBPACK_IMPORTED_MODULE_0__["default"],
    Navbar: dashboard_components_particals_Navbar__WEBPACK_IMPORTED_MODULE_1__["default"],
    FooterBar: dashboard_components_particals_FooterBar__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: function data() {
    return {
      isCollapse: false,
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    dashboard_config_menu__WEBPACK_IMPORTED_MODULE_0__["default"].forEach(function (menu, index) {
      if (menu.children) {
        menu.children.forEach(function (child, key) {
          if (route.name.split(child.uri.name).length > 1) {
            active = "".concat(index, "_").concat(key);
          }
        });
      } else if (route.name.split(menu.uri.name).length > 1) {
        active = "".concat(index);
      }
    });
  ...
  return _c(
    ...
    [
      _c(
        "el-col",
        { attrs: { span: _vm.size } },
        [_c("sidebar", { attrs: { "is-collapse": _vm.isCollapse } })],
        1
      ),
      _vm._v(" "),
      _c("el-col", { attrs: { span: 24 - _vm.size } }, [
        _c(
          "div",
          { attrs: { id: "page-content-wrapper" } },
          [
            _c("navbar", { on: { "change-collapse": _vm.changeCollapse } }),
            _vm._v(" "),
            _c(
              "div",
...
var staticRenderFns = [
  function () {
    ...
    return _c(
      "a",
      { staticStyle: { color: "#6c757d !important" }, attrs: { href: "/" } },
          ...
          menu.children
            ? _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _vm._l(menu.children, function (child, key) {
                    return _c(
                      "el-menu-item",
                      {
                        key: key,
                        attrs: {
                          index: index.toString() + "_" + key.toString(),
                          route: child.uri,
                        },
                      },
                      [
            ...
            : _c(
                "el-menu-item",
                { attrs: { index: index.toString(), route: menu.uri } },
                [
                  _c("i", { class: menu.icon }),
                  _vm._v(" "),
                  _c("template", { slot: "title" }, [
                    _vm._v(
                      "\n        " + _vm._s(_vm.$t(menu.label)) + "\n      "
                    ),
                  ]),
                ],
                2
