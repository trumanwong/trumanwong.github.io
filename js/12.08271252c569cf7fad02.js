...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteFile: function deleteFile(id) {
      ...
      this.$http["delete"]('file/' + id).then(function (response) {
    ...
    getFileInfo: function getFileInfo() {
      ...
      this.$http.get('file', {
        ...
        _this4.pageSize = response.data.per_page;
    ...
    getCategories: function getCategories() {
      ...
      this.$http.get('categories', {
        ...
        _this5.options = response.data.data;
      });
    },
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      [
                        _c("el-input", {
                          attrs: { placeholder: _vm.$t("table.placeholder") },
          ...
          [
            _c(
              "el-table",
              {
                ...
                attrs: { data: _vm.list, border: "", height: "500" },
              },
              [
                _c("el-table-column", {
                  attrs: { fixed: "", label: _vm.$t("table.name") },
                  scopedSlots: _vm._u([
                    {
                      key: "default",
                      fn: function (scope) {
                ...
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "mime_type", label: _vm.$t("table.type") },
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { prop: "size", label: _vm.$t("table.size") },
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: {
                    prop: "created_at",
                    label: _vm.$t("table.created_at"),
                  },
                }),
                _vm._v(" "),
                _c("el-table-column", {
                  attrs: { fixed: "right", label: _vm.$t("table.action") },
                  scopedSlots: _vm._u([
                    {
                      key: "default",
                      fn: function (scope) {
                        return [
                          _vm.checkImageType(scope.row.mime_type)
                            ? _c(
                                "el-button",
                                {
                                  ...
                                  on: {
                                    click: function ($event) {
                                      return _vm.preview(scope.row.path)
                                    },
                                  },
                                },
                          ...
                          _vm.checkPermission("DESTROY_FILE")
                            ? _c(
                                "el-button",
                                {
                                  ...
                                  on: {
                                    click: function ($event) {
                                      return _vm.deleteFile(scope.row.id)
                                    },
                                  },
                                },
