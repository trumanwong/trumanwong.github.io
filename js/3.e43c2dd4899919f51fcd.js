...
/* harmony import */ var fine_uploader_lib_traditional__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! fine-uploader/lib/traditional */ "./node_modules/fine-uploader/lib/traditional.js");
/* harmony import */ var fine_uploader_lib_traditional__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(fine_uploader_lib_traditional__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var emojione__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! emojione */ "./node_modules/emojione/lib/js/emojione.js");
/* harmony import */ var emojione__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(emojione__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var dashboard_components_FileTable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! dashboard/components/FileTable */ "./resources/js/dashboard/components/FileTable.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    FileTable: dashboard_components_FileTable__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  props: {
    article: {
      type: Object,
  ...
  watch: {
    article: function article() {
      if (this.article.category && this.article.tags) {
  ...
  methods: {
    parse: function parse(content) {
      ...
      return emojione__WEBPACK_IMPORTED_MODULE_4___default.a.toImage(marked(content));
    },
    onSubmit: function onSubmit() {
      var _this = this;

      if (!this.tags || !this.selected) {
        this.$message.error('Category and Tag must select one or more.');
        return;
      }
      ...
      this.$http[method](url, this.article).then(function (response) {
        _this.$message.success('You ' + _this.mode + 'd the article success!');
    ...
    contentUploader: function contentUploader() {
      ...
      var contentUploader = new fine_uploader_lib_traditional__WEBPACK_IMPORTED_MODULE_3___default.a.FineUploaderBasic({
        paste: {
        ...
        callbacks: {
          onPasteReceived: function onPasteReceived(file) {
            var promise = new fine_uploader_lib_traditional__WEBPACK_IMPORTED_MODULE_3___default.a.Promise();

            if (file == null || typeof file.type == 'undefined' || file.type.indexOf('image/')) {
              this.$message.error('Only can upload image!');
      ...
      var dragAndDropModule = new fine_uploader_lib_traditional__WEBPACK_IMPORTED_MODULE_3___default.a.DragAndDrop({
          ...
          _c("div", { staticClass: "col-sm-12" }, [
                ...
                [
                  _c("el-input", {
                    ...
                    model: {
                      ...
                      callback: function ($$v) {
                        _vm.$set(_vm.article, "page_image", $$v)
                      },
            ...
            _c("div", { staticClass: "form-group row" }, [
              ...
              _c(
                "div",
                { staticClass: "col-sm-10" },
                [_c("el-input", { attrs: { type: "textarea", id: "editor" } })],
                1
              ),
            ]),
            _vm._v(" "),
                  ...
                  [
                    _c("el-switch", {
                      ...
                      model: {
                        ...
                        callback: function ($$v) {
                          _vm.$set(_vm.article, "is_draft", $$v)
                        },
                  ...
                  [
                    _c("el-switch", {
                      ...
                      model: {
                        ...
                        callback: function ($$v) {
                          _vm.$set(_vm.article, "is_original", $$v)
                        },
